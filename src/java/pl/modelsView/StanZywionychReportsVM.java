...
public class StanZywionychReportsVM {
    ...
    public void stanZywionychReports( @BindingParam("kierKosztow") int kierKosztowId, @BindingParam("kierKosztowNazwa") String kierKosztowNazwa ) throws IOException, Exception{
        ...
        listZest.add("Zestawienie ilościowe");       
        ...
        cmbZestawienia.addEventListener("onChange", new EventListener() {
            public void onEvent(Event event) throws Exception {
                ...
                else if ( cmbZestawienia.getSelectedItem().getValue().toString().equals("Zestawienie ilościowe") )
                { 
        ...
        runExcel.addEventListener("onClick", new EventListener() {
            ...
            public void onEvent(Event arg0) throws Exception {
                ...
                zapiszExcel( okres, kierKosztowId, kierKosztowNazwa );
...
//                }
                ...
                { 
                  try {
                        String okres = tbOkres.getValue().substring(0, 7);
                        System.out.println("Zestawienie ilościowe " + okres + " " + kierKosztowId);
                        zapiszRaportIlosciowy( okres, kierKosztowId, kierKosztowNazwa );
                    } catch (Exception e) {
                        //alert();
                    }
                ...
                { 
                  ...
                  try {
                        String okres = tbOkres.getValue().substring(0, 7);
                        System.out.println("Zestawienie wartościowe " +  okres + " " + kierKosztowId);
    ...
    public void zapiszExcel( String okres, int kkId, String kierKosztowNazwa ) throws IOException, Exception{
        ...
        for ( StanZywionychMMRapRozDTO sZ : stanZywionych ){
           Object[] dok = { sZ.getKk(), sZ.getGz(),  sZ.getSn3(), false };
           tm.addRow(dok);
        }
                                      
        
        ExcelExporter xlsExp = new ExcelExporter();
        String ret = xlsExp.ExportTable(jT.getModel());
...
//                                                table.addCell( ar15 );
    ...
    public void zapiszRaportIlosciowy( String okres, int kkId, String kierKosztowNazwa ) throws IOException, Exception{
        ...
        try {
            ...
            // 02. Generation raport 
            File f = new File("Raport ilosciowy "
                    + kierKosztowNazwa + " "
                    + okres + " "                   
                    + ".pdf");
			...
			//Inserting Table in PDF
			     PdfPTable table=new PdfPTable(8); // number of column
	                     ...
	                     PdfPCell cell = new PdfPCell (new Paragraph ("Sprawozdanie ilosciowe z dzialalnosci kuchni: "  + kierKosztowNazwa, myFont_Naglowek));
				      ...
				      cell_1.setColspan(1); // connect column to one 
                                      ...
                                      PdfPCell cell_2 = new PdfPCell (new Paragraph ("sniadanie", myFont_Posilek));
				      cell_2.setColspan(1); // connect column to one 
                                      cell_2.setHorizontalAlignment (Element.ALIGN_CENTER);
                                      table.addCell(cell_2);
                                      
                                      PdfPCell cell_3 = new PdfPCell (new Paragraph ("2 sniadanie", myFont_Posilek));
				      cell_3.setColspan(1); // connect column to one 
                                      cell_3.setHorizontalAlignment (Element.ALIGN_CENTER);
                                      table.addCell(cell_3);
                                      
                                      PdfPCell cell_4 = new PdfPCell (new Paragraph ("obiad", myFont_Posilek));
				      cell_4.setColspan(1); // connect column to one 
                                      cell_4.setHorizontalAlignment (Element.ALIGN_CENTER);
                                      table.addCell(cell_4);
                                      
                                      PdfPCell cell_5 = new PdfPCell (new Paragraph ("podwieczorek", myFont_Posilek));
				      cell_5.setColspan(1); // connect column to one 
                                      cell_5.setHorizontalAlignment (Element.ALIGN_CENTER);
                                      table.addCell(cell_5);
                                      
                                      PdfPCell cell_6 = new PdfPCell (new Paragraph ("kolacja", myFont_Posilek));
				      cell_6.setColspan(1); // connect column to one 
                                      cell_6.setHorizontalAlignment (Element.ALIGN_CENTER);
                                      table.addCell(cell_6);
                                      
                                      PdfPCell cell_7 = new PdfPCell (new Paragraph ("posilek nocny", myFont_Posilek));
				      cell_7.setColspan(1); // connect column to one 
                                      cell_7.setHorizontalAlignment (Element.ALIGN_CENTER);
                                      table.addCell(cell_7);
                                                                                                                 
                                      PdfPCell cell_8 = new PdfPCell (new Paragraph ("SUMA", myFont_Posilek));
				      cell_8.setColspan(1); // connect column to one 
